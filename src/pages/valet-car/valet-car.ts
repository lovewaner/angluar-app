...
/**
 * Generated class for the ValetCarPage page.
 *
...
@Component({
  selector: 'page-valet-car',
  templateUrl: 'valet-car.html',
})
export class ValetCarPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ValetCarPage');
  }
